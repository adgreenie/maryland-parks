...
function Home() {
  ...
  useEffect(() => {
    const makeApiCall = async () => {
      const url =
        "https://developer.nps.gov/api/v1/parks?stateCode=md&api_key=3LPGi8GvCt8dedPIgTjFNBivWxKmCETdxgEq3aBh"
        ...
        <div className="park-preview">
          <img
            ...
            src={
              park.images[0]
                ? park.images[0].url
                : "https://i.pinimg.com/originals/90/5b/d0/905bd03c111f41c8f656e04f71b42ad8.png"
            }
          />
